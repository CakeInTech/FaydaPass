...
import { plans, Plan } from "../plans.tsx";
...
function SignupContent() {
  ...
  const planConfig = plans.find((p: Plan) => p.id === planType);
      ...
      <div className="min-h-screen py-20 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div
              className={`w-16 h-16 bg-gradient-to-br ${planConfig?.gradient} rounded-2xl flex items-center justify-center mx-auto mb-4`}
            >
              {planConfig?.icon && (
                <planConfig.icon className="w-8 h-8 text-white" />
              )}
            </div>
            ...
            <p className="text-xl text-white/80">{planConfig?.description}</p>
          </motion.div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={`Briefly describe your ${
                    planType === "business" ? "business" : "project"
                  }...`}
                  rows={3}
                />
              </div>
