...
export default function DocsFooter() {
    return (
        <footer className="text-white p-6 mt-12 w-full bg-black border-t border-gray-800">
          <div className="flex flex-col items-center justify-center mx-auto max-w-screen-sm gap-4">
            <div className="flex items-center space-x-2 p-4">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-black text-white group-hover:text-primary-500 transition-colors duration-300">
                  FaydaPass
                </span>
                <span className="text-xs text-white/60 font-medium tracking-wide">KYC API Platform</span>
              </div>
            </div>
          </div>
