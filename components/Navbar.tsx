          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2 ml-4">
                <Link href="/login">
                  <button className="group relative border-2 border-white/30 text-white px-4 py-2 rounded-lg font-medium hover:bg-white/10 backdrop-blur-sm transition-all duration-300">
                    Sign In
                  </button>
                </Link>
                <Link href="/plan-selection">
                  <button className="group relative bg-gradient-to-r from-green-500 to-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:from-green-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">
                    Get Started
            ...
            <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-white/20">
                <Link href="/login" onClick={() => setMobileOpen(false)}>
                  <div className="flex items-center justify-center space-x-2 border-2 border-white/30 text-white font-semibold py-3 rounded-xl hover:bg-white/10 transition-all duration-300 mb-3">
                    <span>Sign In</span>
                  </div>
                </Link>
                <Link href="/plan-selection" onClick={() => setMobileOpen(false)}>
                  <div className="flex items-center justify-center space-x-2 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-indigo-500/50 transition-all duration-300 mb-3">
